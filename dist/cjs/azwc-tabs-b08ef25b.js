...
const index$1 = require('./index-f961ad80.js');
...
const AzwcCollapseT1 = class {
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, null, index$1.h("input", { checked: checked, name: "collapse", type: "checkbox", id: this.titleId, class: "azac-title-input" }), index$1.h("label", { htmlFor: this.titleId, class: "azac-title-box" }, this.labelPlacement === 'right' && (!this.type || this.type === 'sign') && (index$1.h("div", { class: "azac-icon-sign" }, index$1.h("span", null), index$1.h("span", null))), this.labelPlacement === 'right' && this.type === 'arrow' && (index$1.h("div", { class: "azac-icon-arrow" }, index$1.h("span", null))), this.labelPlacement === 'right' && this.type === 'angle-bracket' && (index$1.h("div", { class: "az-angle-bracket" }, index$1.h("span", null), index$1.h("span", null))), index$1.h("slot", { name: "left-icon" }), index$1.h("slot", { name: "title" }), index$1.h("slot", { name: "right-icon" }), this.labelPlacement === 'left' && (!this.type || this.type === 'sign') && (index$1.h("div", { class: "azac-icon-sign" }, index$1.h("span", null), index$1.h("span", null))), this.labelPlacement === 'left' && this.type === 'arrow' && (index$1.h("div", { class: "azac-icon-arrow" }, index$1.h("span", null))), this.labelPlacement === 'left' && this.type === 'angle-bracket' && (index$1.h("div", { class: "az-angle-bracket" }, index$1.h("span", null), index$1.h("span", null)))), index$1.h("div", { class: "azac-contents-box" }, index$1.h("div", { class: "azac-contents" }, index$1.h("slot", { name: "contents" }), index$1.h("slot", null)))));
  }
  get host() { return index$1.getElement(this); }
};
...
const AzwcSwiperNext = class {
  ...
  render() {
    return (index$1.h(index$1.Host, { class: "azwc-swiper-next" }, index$1.h("slot", null)));
  }
};
...
const AzwcSwiperPrev = class {
  ...
  render() {
    return (index$1.h(index$1.Host, { class: "azwc-swiper-prev" }, index$1.h("slot", null)));
  }
};
...
const AzwcSwiperPagination = class {
  ...
  render() {
    return (index$1.h(index$1.Host, { class: "swiper-pagination" }));
  }
};

const AzwcTabs = class {
  constructor(hostRef) {
    index$1.registerInstance(this, hostRef);
  }
  ...
  render() {
    return (index$1.h(index$1.Host, null, index$1.h("div", { class: "aztab" }, index$1.h("button", { class: "aztablinks active", onClick: (event) => { this.openCity(event, 'London'); } }, "London"), index$1.h("button", { class: "aztablinks", onClick: (event) => { this.openCity(event, 'Paris'); } }, "Paris"), index$1.h("button", { class: "aztablinks", onClick: (event) => { this.openCity(event, 'Tokyo'); } }, "Tokyo")), index$1.h("div", { id: "London", class: "aztabcontent active" }, index$1.h("h3", null, "London"), index$1.h("p", null, "London is the capital city of England.")), index$1.h("div", { id: "Paris", class: "aztabcontent" }, index$1.h("h3", null, "Paris"), index$1.h("p", null, "Paris is the capital of France.")), index$1.h("div", { id: "Tokyo", class: "aztabcontent" }, index$1.h("h3", null, "Tokyo"), index$1.h("p", null, "Tokyo is the capital of Japan."))));
  }
};
...
exports.AzwcSwiperNext = AzwcSwiperNext;
exports.AzwcSwiperPagination = AzwcSwiperPagination;
exports.AzwcSwiperPrev = AzwcSwiperPrev;
exports.AzwcTabs = AzwcTabs;
