...
const AzwcDialog = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.customStateChange = createEvent(this, "customStateChange", 7);
...
const AzwcFileManager = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.basePath = '';
...
const AzwcSpinner = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.size = '1em';
...
const AzwcSpinnerMask = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.enabled = 'false';
...
const swiperlib = /*#__PURE__*/Object.freeze({
  ...
  A11y: A11y$1,
  History: History$1,
  HashNavigation: HashNavigation$1,
  Autoplay: Autoplay$1,
...
const AzwcSwiper = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
const AzwcCollapseT1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
