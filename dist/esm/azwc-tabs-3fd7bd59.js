import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './index-d1628334.js';
...
const AzwcCollapseT1 = class {
  ...
  render() {
    ...
    return (h(Host, null, h("input", { checked: checked, name: "collapse", type: "checkbox", id: this.titleId, class: "azac-title-input" }), h("label", { htmlFor: this.titleId, class: "azac-title-box" }, this.labelPlacement === 'right' && (!this.type || this.type === 'sign') && (h("div", { class: "azac-icon-sign" }, h("span", null), h("span", null))), this.labelPlacement === 'right' && this.type === 'arrow' && (h("div", { class: "azac-icon-arrow" }, h("span", null))), this.labelPlacement === 'right' && this.type === 'angle-bracket' && (h("div", { class: "az-angle-bracket" }, h("span", null), h("span", null))), h("slot", { name: "left-icon" }), h("slot", { name: "title" }), h("slot", { name: "right-icon" }), this.labelPlacement === 'left' && (!this.type || this.type === 'sign') && (h("div", { class: "azac-icon-sign" }, h("span", null), h("span", null))), this.labelPlacement === 'left' && this.type === 'arrow' && (h("div", { class: "azac-icon-arrow" }, h("span", null))), this.labelPlacement === 'left' && this.type === 'angle-bracket' && (h("div", { class: "az-angle-bracket" }, h("span", null), h("span", null)))), h("div", { class: "azac-contents-box" }, h("div", { class: "azac-contents" }, h("slot", { name: "contents" }), h("slot", null)))));
  }
  get host() { return getElement(this); }
};
